...
public class Model {	
	public static Logger logger = UIMAFramework.getLogger(Inferencer.class);
	//---------------------------------------------------------------
	//	Class Variables
	//---------------------------------------------------------------
	...
	protected boolean readOthersFile(String otherFile){
		...
		try {
			...
			logger.log(Level.WARNING,"Error while reading other file:" + e.getMessage());
			e.printStackTrace();
			return false;
		}
		return true;
	...
	protected boolean readTAssignFile(String tassignFile){
		try {
			...
			for (i = 0; i < M; i++){
				...
				for (j = 0; j < length; j++){
					...
					if (tknr2.countTokens() != 2){
						logger.log(Level.WARNING,"Invalid word-topic assignment line\n");
						return false;
					}
			...
			logger.log(Level.WARNING,"Error while loading model: " + e.getMessage());
			e.printStackTrace();
			return false;
		}
		return true;
	...
	public boolean saveModelTAssign(String filename){
		...
		try{
			...
			logger.log(Level.WARNING,"Error while saving model tassign: " + e.getMessage());
			e.printStackTrace();
			return false;
		}
		return true;
	...
	public boolean saveModelTheta(String filename){
		try{
			...
			logger.log(Level.WARNING,"Error while saving topic distribution file for this model: " + e.getMessage());
			e.printStackTrace();
			return false;
		}
		return true;
	...
	public boolean saveModelPhi(String filename){
		try {
			...
			logger.log(Level.WARNING,"Error while saving word-topic distribution:" + e.getMessage());
			e.printStackTrace();
			return false;
		}
		return true;
	...
	public boolean saveModelOthers(String filename){
		try{
			...
			logger.log(Level.WARNING,"Error while saving model others:" + e.getMessage());
			e.printStackTrace();
			return false;
		}
		return true;
	...
	public boolean saveModelTwords(String filename){
		try{
			...
			logger.log(Level.WARNING,"Error while saving model twords: " + e.getMessage());
			e.printStackTrace();
			return false;
		}
		return true;
	...
	public boolean initNewModel(LDACmdOption option){
		...
		if (data == null){
			logger.log(Level.WARNING,"Fail to read training data!\n");
			return false;
		}
...
//		System.out.println("V:" + V);
	...
	public boolean initNewModel(LDACmdOption option, Model trnModel){
		...
		if (dataset == null){
			logger.log(Level.WARNING,"Fail to read dataset!\n");
			return false;
		}
	...
	public boolean initEstimatedModel(LDACmdOption option){
		...
		if (!loadModel()){
			logger.log(Level.WARNING,"Fail to load word-topic assignment file of the model!\n");
			return false;
		}
		
		logger.log(Level.FINE,"Model loaded:");
		logger.log(Level.FINE,"\talpha:" + alpha);
		logger.log(Level.FINE,"\tbeta:" + beta);
		logger.log(Level.FINE,"\tM:" + M);
		logger.log(Level.FINE,"\tV:" + V);		
